...
#ifndef __hsr_drake_sim_lcmt_hsr_sim_status_hpp__
#define __hsr_drake_sim_lcmt_hsr_sim_status_hpp__
...
int lcmt_hsr_sim_status::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_status::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcmt_hsr_sim_status::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcmt_hsr_sim_status::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcmt_hsr_sim_status::getTypeName()
{
    return "lcmt_hsr_sim_status";
}

int lcmt_hsr_sim_status::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_status::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_status::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lcmt_hsr_sim_status::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xdc3a34503c11a2b0LL;
