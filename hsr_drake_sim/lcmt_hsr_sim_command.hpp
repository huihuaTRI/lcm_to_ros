...
#ifndef __hsr_drake_sim_lcmt_hsr_sim_command_hpp__
#define __hsr_drake_sim_lcmt_hsr_sim_command_hpp__
...
namespace hsr_drake_sim
{

/**
 * Commands a single set of joint states for the HSR.  All angular
 * positions/velocities are expressed in radians and radians/second.
 * The timestamp utime is in microseconds.
 */
class lcmt_hsr_sim_command
{
    public:
        int64_t    utime;
...
int lcmt_hsr_sim_command::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_command::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcmt_hsr_sim_command::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcmt_hsr_sim_command::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcmt_hsr_sim_command::getTypeName()
{
    return "lcmt_hsr_sim_command";
}

int lcmt_hsr_sim_command::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_command::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lcmt_hsr_sim_command::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lcmt_hsr_sim_command::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x8cf6b83b46dec105LL;
